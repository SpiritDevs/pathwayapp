...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@pathwayos/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "pathwayos-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "pathwayos-relay-dpop-access+jwt";
...
>()("pathwayos-relay/auth/RelayTokens") {}
