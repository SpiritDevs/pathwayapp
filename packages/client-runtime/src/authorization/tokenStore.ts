...
import { RelayManagedEndpoint } from "@pathwayos/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@pathwayos/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@pathwayos/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
