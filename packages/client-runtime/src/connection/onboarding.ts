import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@pathwayos/contracts";
import { resolveRemotePairingTarget } from "@pathwayos/shared/remote";
...
>()("@pathwayos/client-runtime/connection/onboarding/ConnectionOnboarding") {}
