import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@pathwayos/contracts";
...
}>("@pathwayos/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.issuesSubscribe
  | typeof WS_METHODS.issuesSubscribeDetail
