...
export const RELAY_LINK_PROOF_TYP = "pathwayos-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "pathwayos-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "pathwayos-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "pathwayos-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "pathwayos-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "pathwayos-env-activity+jwt";
