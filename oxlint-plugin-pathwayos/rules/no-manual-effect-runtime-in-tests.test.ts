...
const rule = createOxlintRuleHarness("pathwayos/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("pathwayos/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("pathwayos/no-manual-effect-runtime-in-tests");
