  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new pathwayOS prerelease is available for nightly testers."
          : "A new pathwayOS latest release is available.",
...
).pipe(Command.withDescription("Post a pathwayOS release announcement to Discord."));
