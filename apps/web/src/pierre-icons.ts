...
const PIERRE_ICON_SPRITE_ID = "pathwayos-pierre-file-icon-sprite";

const PathwayOS_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="pathwayos-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="pathwayos-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="pathwayos-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="pathwayos-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="pathwayos-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="pathwayos-file-icon-pnpm" viewBox="0 0 32 32">
...
export const PathwayOS_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: PathwayOS_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "pathwayos-file-icon-package-json",
    "tsconfig.json": "pathwayos-file-icon-tsconfig",
    "agents.md": "pathwayos-file-icon-agents",
    "claude.md": "pathwayos-file-icon-claude",
    "readme.md": "pathwayos-file-icon-readme",
    "pnpm-lock.yaml": "pathwayos-file-icon-pnpm",
    "pnpm-workspace.yaml": "pathwayos-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(PathwayOS_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${PathwayOS_FILE_ICON_SPRITE}`;
