import { EnvironmentId, MessageId } from "@pathwayos/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/pathwayos/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/pathwayos"
      />,
    );

    expect(markup).toContain("pathwayos/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/pathwayos/apps/web/src/session-logic.ts");
  });
