...
describe("getSidebarThreadIdsToPrewarm", () => {
  it("returns only the first visible thread ids up to the prewarm limit", () => {
    expect(getSidebarThreadIdsToPrewarm(["t1", "t2", "pathwayos"], 2)).toEqual(["t1", "t2"]);
  });
    ...
    expect(
      resolveSidebarNewThreadSeedContext({
        ...
        activeThread: {
          ...
          worktreePath: "/repo/.pathwayos/worktrees/existing",
        },
        activeDraftThread: {
          projectId: "project-1",
          branch: "feature/draft",
          worktreePath: "/repo/.pathwayos/worktrees/draft",
          envMode: "worktree",
