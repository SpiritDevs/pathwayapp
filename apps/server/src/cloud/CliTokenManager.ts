...
export class CloudCliCredentialRemovalError extends Schema.TaggedErrorClass<CloudCliCredentialRemovalError>()(
  ...
  override get message(): string {
    return "Could not remove the stored pathwayOS Connect CLI credential.";
  }
}
...
export class CloudCliCredentialRefreshError extends Schema.TaggedErrorClass<CloudCliCredentialRefreshError>()(
  ...
  override get message(): string {
    return "Could not refresh the pathwayOS Connect CLI credential.";
  }
}
...
export class CloudCliCredentialReadError extends Schema.TaggedErrorClass<CloudCliCredentialReadError>()(
  ...
  override get message(): string {
    return "Could not read the stored pathwayOS Connect CLI credential.";
  }
}
...
export class CloudCliAuthorizationError extends Schema.TaggedErrorClass<CloudCliAuthorizationError>()(
  ...
  override get message(): string {
    return "Could not authorize the pathwayOS Connect CLI.";
  }
}
...
export class CloudCliAuthorizationTimeoutError extends Schema.TaggedErrorClass<CloudCliAuthorizationTimeoutError>()(
  ...
  override get message(): string {
    return "Timed out waiting for pathwayOS Connect authorization.";
  }
}
...
>()("pathwayos/cloud/CliTokenManager/CloudCliTokenManager") {}
    ...
    const callbackRoute = HttpRouter.add(
      ...
      Effect.gen(function* () {
        ...
        if (url.searchParams.get("state") !== state || !code) {
          return HttpServerResponse.text("Invalid pathwayOS Connect authorization callback.", {
            status: 400,
          });
        }
...
<html>
  <body style="font-family: sans-serif; text-align: center; margin-top: 50px;">
    <h1>pathwayOS Connect authorization complete</h1>
...
`;
    ...
    yield* Console.log(
      `Open this URL to authorize pathwayOS Connect:\n${authorizationUrl.toString()}\n`,
    );
