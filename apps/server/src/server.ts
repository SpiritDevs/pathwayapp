import { EnvironmentHttpApi } from "@pathwayos/contracts";
...
import { disableTailscaleServe, ensureTailscaleServe } from "@pathwayos/tailscale";

// Effect's default preemptive shutdown waits 20s before finalizing request scopes.
// PathwayOS's primary transport is long-lived WebSocket RPC, whose Effect scope finalizer
      ...
      Effect.gen(function* () {
        ...
        yield* Effect.forkScoped(
          Effect.sleep("250 millis").pipe(
            ...
            Effect.tap(() =>
              Effect.logInfo("pathwayOS Connect desired link reconciled on startup"),
            ),
            Effect.catch((cause) =>
              Effect.logWarning("Failed to reconcile pathwayOS Connect desired link on startup", {
                cause,
              }),
            ),
          ),
