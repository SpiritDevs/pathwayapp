import { type GrokSettings, ProviderDriverKind } from "@pathwayos/contracts";
...
const PathwayOS_CODE_OAUTH_REFERRER = "pathwayos";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: PathwayOS_CODE_OAUTH_REFERRER,
    },
  };
}
