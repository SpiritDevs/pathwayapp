...
import { parseCliArgs } from "@pathwayos/shared/cliArgs";
import {
  ApprovalRequestId,
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleAskUserQuestion = Effect.fn("handleAskUserQuestion")(function* (
        ...
        // expected lookup key. See https://github.com/pingdotgg/pathwayos/issues/2388
      ...
      const queryOptions: ClaudeQueryOptions = {
        ...
        systemPrompt:
          input.sessionKind === "chat"
            ? { type: "preset", preset: "claude_code", append: CHAT_CONVERSATION_INSTRUCTIONS }
