...
import { makeKeyedCoalescingWorker } from "@pathwayos/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@pathwayos/shared/hostProcess";
import { getTerminalLabel } from "@pathwayos/shared/terminalLabels";
...
>()("pathwayos/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("PATHWAYOS_")) {
    return true;
  }
