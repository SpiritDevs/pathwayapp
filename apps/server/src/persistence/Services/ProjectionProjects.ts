 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@pathwayos/contracts";
...
>()("pathwayos/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
