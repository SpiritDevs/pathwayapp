import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@pathwayos/contracts";
...
import { KeybindingsConfigError } from "@pathwayos/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "pathwayos-keybindings-test-",
        }),
      ),
    ),
  );
