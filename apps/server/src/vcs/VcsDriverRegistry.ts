...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@pathwayos/contracts";
import { VcsUnsupportedOperationError } from "@pathwayos/contracts";
...
>()("pathwayos/vcs/VcsDriverRegistry") {}
