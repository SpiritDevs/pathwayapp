...
import { dedupeRemoteBranchesWithLocalMatches } from "@pathwayos/shared/git";
import { compactTraceAttributes } from "@pathwayos/shared/observability";
import { decodeJsonResult } from "@pathwayos/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `pathwayos-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
