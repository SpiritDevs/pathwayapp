...
import { EnvironmentProject, EnvironmentThreadShell } from "@pathwayos/client-runtime/state/shell";
...
describe("groupProjectsByRepository", () => {
  it("groups projects across environments by repository identity", () => {
    ...
    expect(groups[0]).toMatchObject({
      key: "github.com/pathwayos/pathwayos",
      title: "pathwayOS",
      subtitle: "pathwayos/pathwayos",
      projectCount: 2,
      threadCount: 2,
    });
    expect(
