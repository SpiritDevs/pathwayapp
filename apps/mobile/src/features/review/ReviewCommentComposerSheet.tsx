      ...
      <KeyboardAvoidingView automaticOffset behavior="padding" style={{ flex: 1 }}>
        ...
        >
          <View className="flex-row items-center justify-between py-2">
            ...
            <Text className="text-lg font-pathwayos-bold text-foreground">Add Comment</Text>
          ...
          {!target ? (
            <View className="rounded-[22px] border border-border bg-card px-4 py-5">
              <Text className="text-base font-pathwayos-bold text-foreground">No selection</Text>
            ...
            <View className="min-h-0 flex-1 gap-4">
              <View className="gap-1 px-1">
                <Text className="text-2xs font-pathwayos-bold uppercase text-foreground-muted">
                  {selectionLabel}
                </Text>
                <Text
                      ...
                      {selectedLines.map((line) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <Text
                              className="w-9 py-1 pr-1 text-right text-2xs font-pathwayos-medium text-foreground-muted"
              ...
              <View className="min-h-0 flex-1 gap-2">
                <Text className="text-sm font-pathwayos-bold text-foreground">Comment</Text>
