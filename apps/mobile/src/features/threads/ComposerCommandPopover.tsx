...
import type { ComposerTriggerKind } from "@pathwayos/shared/composerTrigger";
import type { ServerProviderSkill, ServerProviderSlashCommand } from "@pathwayos/contracts";
...
const CommandRow = memo(function CommandRow(props: {
  ...
  return (
    ...
    >
      ...
      <Text
        className="text-base font-pathwayos-medium text-foreground"
        numberOfLines={1}
        style={{ flexShrink: 0 }}
      >
        {props.item.label}
    ...
    <PopoverSurface isDarkMode={isDarkMode}>
      {label ? (
        <View style={{ paddingHorizontal: 14, paddingTop: 10, paddingBottom: 4 }}>
          <Text
            className="text-3xs font-pathwayos-bold text-foreground-muted"
