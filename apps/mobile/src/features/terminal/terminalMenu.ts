import { type KnownTerminalSession } from "@pathwayos/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@pathwayos/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@pathwayos/shared/terminalLabels";
...
} from "@pathwayos/shared/terminalLabels";
