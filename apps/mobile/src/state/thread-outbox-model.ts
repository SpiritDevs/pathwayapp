import { isTransportConnectionErrorMessage } from "@pathwayos/client-runtime/errors";
import type { EnvironmentShellStatus } from "@pathwayos/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,
