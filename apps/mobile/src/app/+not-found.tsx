...
export default function NotFoundRoute() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-pathwayos-bold text-foreground" selectable>
        Route not found
      </Text>
      <Link href="/" asChild>
        <Pressable
        ...
        >
          <Text className="text-base font-pathwayos-bold text-primary-foreground">Return home</Text>
        </Pressable>
      </Link>
    </ScrollView>
  );
