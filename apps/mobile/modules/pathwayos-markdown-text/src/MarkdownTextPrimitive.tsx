...
import PathwayOSMarkdownTextRunNativeComponent from "./PathwayOSMarkdownTextRunNativeComponent";
import PathwayOSMarkdownTextNativeComponent from "./PathwayOSMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <PathwayOSMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <PathwayOSMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
