...
const customSprite = webIconSource.match(/const PathwayOS_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the PathwayOS Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "pathwayos-file-icon-agents",
  claude: "pathwayos-file-icon-claude",
  package: "pathwayos-file-icon-package-json",
  pnpm: "pathwayos-file-icon-pnpm",
  readme: "pathwayos-file-icon-readme",
  tsconfig: "pathwayos-file-icon-tsconfig",
};
